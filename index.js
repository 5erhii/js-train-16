...
function validateUserInput(userInput) {
  ...
  else if (!userInput.hasOwnProperty('password')) {
...
function calculateTotalPrice(products) {
  ...
  const timeLabel = "calculateTotalPrice";
...
function countVowelsAndConsonants(word) {
  ...
  console.log("Кількість голосних: " + countVowels);
  console.log("Кількість приголосних: " + countConsonants);
  // Скидаємо лічильники
